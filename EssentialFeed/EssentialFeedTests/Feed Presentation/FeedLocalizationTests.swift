...
final class FeedLocalizationTests: XCTestCase {
    ...
    func test_localizationStrings_haveKeysAndValuesForAllSupportLocalization() {
        ...
        let localizedStringKeys = allLocalizedStringKyes(in: localizationBundles, table: table)
    ...
    private func allLocalizedStringKyes(in bundles: [LocalizedBundle], table: String, file: StaticString = #file, line: UInt = #line) -> Set<String> {
