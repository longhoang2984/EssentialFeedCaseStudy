...
private func allLocalizedStringKyes(in bundles: [LocalizedBundle],
                                    table: String,
                                    file: StaticString = #file,
...
func assertLocalizedKeyAndValuesExist(_ presentationBundle: Bundle,
                                      _ table: String,
                                      file: StaticString = #file,
                                      line: UInt = #line) {
    let localizationBundles = allLocalizationBundles(in: presentationBundle, file: file, line: line)
    let localizedStringKeys = allLocalizedStringKyes(in: localizationBundles, table: table,  file: file, line: line)
