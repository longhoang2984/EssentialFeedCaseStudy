...
final class FeedUIIntegrationTests: XCTestCase {
    ...
    func test_feedContent_withTitle() {
        let (sut, _) = makeSUT()
    ...
    func test_LoadFeedCompletion_renderSuccessfullyLoaddedEmptyFeedAfterNonEmptyFeed() {
    ...
    func test_errorView_doesNotRenderErrorLoad() {
        let (sut, _) = makeSUT()
        sut.loadViewIfNeeded()
